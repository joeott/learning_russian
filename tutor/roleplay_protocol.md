...
### Scenario 21 — Quick descriptions and pace repair (id: adverb_adjective_survival)
...
### Scenario 22 — Budva trip check-in (id: budva_trip_checkin)
...
### Scenario 23 — Daily routine check-in (id: daily_routine_checkin)
...
### Scenario 24 — My day mini-story (id: daily_routine_story)
...
### Scenario 25 — Work and clients check-in (id: work_business_checkin)
...
### Scenario 26 — Holiday and family plans (id: holiday_celebration_checkin)
...
### Scenario 27 — Cultural extras recognition (id: cultural_bonus_recognition)
...
### Scenario 28 — Airport and hotel arrival (id: budva_airport_hotel_checkin)
