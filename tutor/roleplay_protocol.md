...
## The 35 Role-Play Scenarios (increasing difficulty)
...
### Scenario 29 — Budva trip check-in (id: budva_trip_checkin)
...
### Scenario 30 — Daily routine check-in (id: daily_routine_checkin)
...
### Scenario 31 — My day mini-story (id: daily_routine_story)
...
### Scenario 32 — Work and clients check-in (id: work_business_checkin)
...
### Scenario 33 — Holiday and family plans (id: holiday_celebration_checkin)
...
### Scenario 34 — Cultural extras recognition (id: cultural_bonus_recognition)
...
### Scenario 35 — Airport and hotel arrival (id: budva_airport_hotel_checkin)
