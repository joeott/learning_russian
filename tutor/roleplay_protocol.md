...
### Scenario 26 — Budva trip check-in (id: budva_trip_checkin)
...
### Scenario 27 — Daily routine check-in (id: daily_routine_checkin)
...
### Scenario 28 — My day mini-story (id: daily_routine_story)
...
### Scenario 29 — Work and clients check-in (id: work_business_checkin)
...
### Scenario 30 — Holiday and family plans (id: holiday_celebration_checkin)
...
### Scenario 31 — Cultural extras recognition (id: cultural_bonus_recognition)
...
### Scenario 32 — Airport and hotel arrival (id: budva_airport_hotel_checkin)
