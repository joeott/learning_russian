...
readiness checks, an explicit listening ladder, and criterion-aware role-play
outcomes. The next foundations should broaden oral transfer without weakening
the guardrails:
