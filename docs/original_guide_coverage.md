...
- Generated content: 204 items across 14 modules, plus 20 generated conjugation drills
...
2. Airport/hotel variants for Budva if Kadriya confirms they are useful.
3. Broader verb-pronoun drills only after `я` and formal `вы` are automatic.
