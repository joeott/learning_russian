...
The **single source of truth** is [`content/content.json`](content/content.json), generated by a script. Edit the data and everything regenerates:
...
```
content/        canonical content.json (109 items, stress-marked)
