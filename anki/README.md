...
`russian_family_visit.txt` is a TAB-separated Anki import file (336 cards across
19 modules). `russian_family_visit_contextual.txt` is a companion import with
...
116 `recognize`-tagged items (questions relatives will fire at you), the reverse
...
[`anki/media/`](media/) (336 files). To make them play:
...
- **New cards/day: 10–15.** With 336 cards that ramps you in fully over ~3
...
- **Study priority phrases first.** The deck has **336 cards across 19 modules**,
...
- 336 cards total, 19 modules:
  ...
  modal_ability (16), work_business (16), legal_recognition (15), celebrations (14),
  cultural_bonus (9), travel_budva (28), verbs (10).
- 116 cards tagged `recognize` (18 listening + 7 family + 6 food + 3 calendar/weather + 25 numbers/quantities + 6 hobbies/places + 5 modal + 5 daily-routine + 2 work/business + 15 legal + 5 celebrations + 9 cultural bonus + 10 Budva/travel items you mainly need to
  *understand when heard*).
- 10 cards currently carry a "⚠ rehearse with your wife" reminder.
- 13 cards show a "(male form)" marker — say these in the masculine.
