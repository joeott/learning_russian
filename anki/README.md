...
`russian_family_visit.txt` is a TAB-separated Anki import file (320 cards across
18 modules). `russian_family_visit_contextual.txt` is a companion import with
...
111 `recognize`-tagged items (questions relatives will fire at you), the reverse
...
[`anki/media/`](media/) (320 files). To make them play:
...
- **New cards/day: 10–15.** With 320 cards that ramps you in fully over ~3
...
- **Study priority phrases first.** The deck has **320 cards across 18 modules**,
...
- 320 cards total, 18 modules:
  ...
  work_business (16), legal_recognition (15), celebrations (14),
  cultural_bonus (9), travel_budva (28), verbs (10).
- 111 cards tagged `recognize` (18 listening + 7 family + 6 food + 3 calendar/weather + 25 numbers/quantities + 6 hobbies/places + 5 daily-routine + 2 work/business + 15 legal + 5 celebrations + 9 cultural bonus + 10 Budva/travel items you mainly need to
