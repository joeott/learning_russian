...
`russian_family_visit.txt` is a TAB-separated Anki import file (436 cards across
25 modules). `russian_family_visit_contextual.txt` is a companion import with
...
[`anki/media/`](media/) (436 files). To make them play:
...
- **New cards/day: 10–15.** With 436 cards that ramps you in fully over ~4
...
- **Study priority phrases first.** The deck has **436 cards across 25 modules**,
...
- 436 cards total, 25 modules:
  ...
  seasonal_activities (16), adverbs_adjectives (14), daily_routine (29), leisure_places (21),
